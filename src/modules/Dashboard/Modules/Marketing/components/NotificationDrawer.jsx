...
export const AddNotificationDrawer = ({ isOpen, handleModalClose, onSuccess, values }) => {
	return (
		<DrawerDefault
						...
						<div className="row g-4">
							...
							<div className="col-12">
								<FastField
                                    ...
                                    options={[{label:"Mijozlar",value:"1"},{label:"Kuryerlar",value:"2"}]}
							    />
							</div>
							<div className="col-12">
								<FastField
                                    ...
                                    options={
                                        ...
                                        :
                                        [
                                            {label:"sayt",value:"1"},{label:"mobil ilova",value:"2"},{label:"bot",value:"3"}
                                        ]
                                    }
