      ...
      {({ setFieldValue }) => (
        <>
          ...
          <Field
            ...
            className="filter__control mr_15 min-width_150 w_full"
          ...
          <Field
            ...
            size="xsm"
            className="filter__control min-width_150 w_full"
            initialValue={[constants.selectAll]}
            getOptionLabel={(option) =>
              "label" in option
                ? option.label
          ...
          <Field
            ...
            placeholder="Vaqti"
            size="xsm"
            className="filter__control min-width_150 ml_15 w_full"
            initialValue={[constants.selectAll]}
            getOptionLabel={(option) =>
              "label" in option
                ? option.label
